  ...
  const handleSubmit = (e) => {
    ...
    if (formType === 'login') {
      const loginRequest = async () => {
        try {
          const response = await axios.post('https://ieee-hackathon-pokedex-backend.vercel.app/signin', {
      ...
      const registerRequest = async () => {
        try {
          const response = await axios.post('https://ieee-hackathon-pokedex-backend.vercel.app/signup', {
